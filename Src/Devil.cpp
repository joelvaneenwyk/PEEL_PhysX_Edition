...
// static void			(ILAPIENTRY* gFunc_ilDeleteImage)	(const ILuint
// Num)				= null;
static ILvoid(ILAPIENTRY *gFunc_ilDeleteImages)(ILsizei Num,
                                                const ILuint *Images) = null;
...
static ILboolean(ILAPIENTRY *gFunc_ilTexImage)(ILuint Width, ILuint Height,
...
bool InitDevil() {
  ...
  *(void **)&gFunc_ilDeleteImages =
      IceCore::BindSymbol(gHandle, "ilDeleteImages");
...
bool SaveWithDevil(const char *filename, const Picture &pic) {
  ...
  (gFunc_ilTexImage)(pic.GetWidth(), pic.GetHeight(), 1, 4, IL_RGBA,
                     IL_UNSIGNED_BYTE, pic.GetPixels());
